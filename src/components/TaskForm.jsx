...
import { X, Plus, RotateCcw, Save, Sparkles } from 'lucide-react'
        ...
        <>
            <div className='fixed inset-0 flex justify-center items-center bg-black/40 backdrop-blur-sm z-50 p-4'>
                ...
                <div className='w-full max-w-2xl relative'>
                    <div className='bg-white/90 backdrop-blur-xl rounded-3xl border border-purple-200/50 shadow-2xl shadow-purple-100/20 overflow-hidden max-h-[90vh] overflow-y-auto'>
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                                ...
                                <div className='space-y-2'>
                                    <label className='text-sm font-semibold text-purple-800'>Status</label>
                                    <select
                                        name="status"
                            ...
                            {/* Summary */}
                            <div className='space-y-2'>
                                <label className='text-sm font-semibold text-purple-800'>Summary</label>
                                <input
                                    type="text"
                                    name="summary"
                            ...
                            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                                <div className='space-y-2'>
                                    <label className='text-sm font-semibold text-purple-800'>Start Date & Time</label>
                                    <input
                                        type="datetime-local"
                                        name="startDateTime"
                                ...
                                <div className='space-y-2'>
                                    <label className='text-sm font-semibold text-purple-800'>End Date & Time</label>
                                    <input
                                        type="datetime-local"
                                        name="endDateTime"
